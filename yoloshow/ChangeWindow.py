...
def yoloshowvsSHOW():
    ...
    glo.set_value(
        'yoloname1', "yolov5 yolov7 yolov8 yolov9 yolov10 yolov5-seg yolov8-seg rtdetr yolov8-pose yolov8-obb"
    )
    glo.set_value(
        'yoloname2', "yolov5 yolov7 yolov8 yolov9 yolov10 yolov5-seg yolov8-seg rtdetr yolov8-pose yolov8-obb"
    )
