...
from yolocode.yolov7.models.yolo import Model
from yolocode.yolov7.utils.general import check_requirements, set_logging
...
if __name__ == '__main__':
    model = custom(path_or_model='../../ptfiles/yolov7.pt')  # custom example
